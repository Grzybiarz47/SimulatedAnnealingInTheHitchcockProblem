...
public:
    ...
    static void find_first_solution(const Graph&, std::vector<ivector>&);
    ...
    static bool find_zero_matrix(std::vector<dvector>&, const std::set<vertex_ivalue_pair>&, const std::vector<dvector>&);
    ...
    static void find_cycle(const Graph&, const std::set<vertex_ivalue_pair>&, const vertex_ivalue_pair& p,
